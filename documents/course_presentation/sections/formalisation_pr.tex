...
\begin{frame}{Оптимальная цепочка, minimax} %граф, содержащий всё.
%Выражение оценки через сумму разменов. \\
...
\begin{frame}{Метод нахождения оптимальной цепочки} %граф, содержащий всё.
